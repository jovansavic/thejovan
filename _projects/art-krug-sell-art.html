---
title: Web Design and Development for Art Selling Startup
tags:
- UI/UX Design, Front-End Development, WordPress Development
layout: project
place: 999
...
project_background: "#0061FF"
client_name: Art Krug (Stefan Tomic - Owner/Founder)
client_location: Serbia, Europe
what_they_do: Art Krug is another startup started by Stefan Tomic. Stefan wants a
  way to present artwork from his clients (artists), and sell it via the website.
---
...
<div class="mw-920 m-auto section-padding">
	...
	<img class="w-md-80 d-block m-auto" src="{{site.baseurl}}/assets/images/work/art-krug/content-strategy.jpg" alt="{{page.name}} | {{page.description}} | {{page.client_location}}" title="{{page.name}} | {{page.description}} | Content Strategy" data-animate>
	...
	<img class="w-md-80 d-block m-auto" src="{{site.baseurl}}/assets/images/work/art-krug/art-sell-wireframes.png" alt="{{page.name}} | {{page.description}} | {{page.client_location}}" title="{{page.name}} | {{page.description}} | Wireframes" data-animate>
	...
	<img class="mw-100 d-block m-auto" data-animate src="{{site.baseurl}}/assets/images/work/artsell-thumb.png" alt="{{page.name}} | {{page.description}} | {{page.client_location}}" title="{{page.name}} | {{page.description}} | Landing page">
	<br><br>
	<!-- Color Scheme -->
	<strong class="strong-small" data-animate>
		Color Scheme
	</strong><br><br>
	<div class="color-box mr-1" style="background-color: #0061FF" data-animate></div>
	<div class="color-box mr-1" style="background-color: rgba(0,0,0,1)" data-animate></div>
	<div class="color-box mr-1" style="background-color: rgba(0,0,0,.54)" data-animate></div>
	<div class="color-box" style="background-color: #F5F5F5" data-animate></div>
	<br>
	<br>
